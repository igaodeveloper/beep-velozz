...
export default function GamificationDashboard({
  ...
  const [activeTab, setActiveTab] = useState<
    "profile" | "achievements" | "leaderboard" | "challenges"
  >("profile");
  const slideAnim = useSharedValue(0);

  // Calcular progresso do nível
  const levelProgress = useMemo(
    () => gamification.getLevelProgress(),
    ...
    <View style={[styles.section, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        <View style={styles.levelContainer}>
          ...
          >
            {gamification.formatExperience(
              gamification.profile?.experience || 0,
            )}{" "}
            XP
          </Text>
        </View>
                ...
                >
                  <View
                    style={[
                      styles.progressFill,
                      {
                        backgroundColor: gamification.getRarityColor(
                          item.rarity,
                        ),
          ...
          return (
            ...
            >
              ...
              <View style={styles.playerInfo}>
                ...
                <Text
                  style={[styles.playerStats, { color: colors.textSecondary }]}
                >
                  Nível {item.level} • {gamification.formatPoints(item.score)}{" "}
                  pts
                </Text>
              </View>
