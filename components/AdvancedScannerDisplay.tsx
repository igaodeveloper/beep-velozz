...
export default function AdvancedScannerDisplay({
  ...
  const [displayAnalysis, setDisplayAnalysis] =
    useState<AdvancedScanAnalysis | null>(null);
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          >
            ...
            {displayAnalysis.marketplace && (
              <Text
                style={{ color: typeColor.text, fontSize: 11, marginTop: 6 }}
              >
                📍 {displayAnalysis.marketplace}
              </Text>
            )}
          ...
          <View
            style={[
              ...
              {
                backgroundColor:
                  getConfidenceColor(displayAnalysis.confidence) + "15",
          ...
          >
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                ...
                >
                  {getConfidenceLabel(displayAnalysis.confidence)} (
                  {displayAnalysis.confidence_score}%)
                </Text>
              </View>
            </View>
          </View>
            ...
            <View style={[styles.infoCard, { borderColor: colors.border }]}>
              ...
              >
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text
                    style={{
                      color: displayAnalysis.checksum_valid
                        ? "#22c55e"
                        : "#ef4444",
                      fontSize: 13,
                      fontWeight: "600",
          ...
          {displayAnalysis.is_suspicious &&
            displayAnalysis.anomaly_flags.length > 0 && (
            ...
            >
              ...
              <View style={{ gap: 8 }}>
                ...
                <DetailRow
                  label="Padrão"
                  value={
                    displayAnalysis.raw_analysis.looks_like_barcode
                      ? "Barcode Numérico"
                      : "Alfanumérico"
                  }
                  colors={colors}
...
function DetailRow(props: { label: string; value: string; colors: any }) {
