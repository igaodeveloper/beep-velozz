...
const LazyComponents = {
  ...
  OptimizedIndustrialScanner: React.lazy(
...
export default function UltraOptimizedApp() {
  ...
  const handleStartSession = useCallback(
    (operatorName: string, driverName: string, declaredCounts: any) => {
    ...
    switch (screen) {
      ...
      case "report":
        return completedSession
          ? React.createElement(LazyComponents.ReportView, {
