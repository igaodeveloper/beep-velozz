export type ThemeName = 'light' | 'dark' | 'ocean' | 'forest' | 'sunset' | 'midnight' | 'arctic' | 'volcano' | 'rose' | 'emerald' | 'amber' | 'ocean-light' | 'forest-light' | 'sunset-light' | 'midnight-light' | 'volcano-light' | 'rose-light' | 'emerald-light' | 'amber-light';
