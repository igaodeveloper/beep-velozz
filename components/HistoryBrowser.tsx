...
export default function HistoryBrowser({
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.bg }}>
            ...
            return (
              <TouchableOpacity
                ...
                style={{
                  ...
                  borderRadius: 14,
                  borderWidth: 1,
                  borderColor: session.hasDivergence
                    ? "#78350f"
                    : colors.surface2,
                  padding: 16,
                  marginBottom: 12,
      ...
      {/* Bottom button */}
      <View
        style={{ padding: 16, borderTopWidth: 1, borderTopColor: "#1e293b" }}
      >
        <TouchableOpacity
...
function CountBadge({
  ...
  return (
    ...
    >
      ...
      <Text
        style={{ color: colors.textSubtle, fontSize: 9, fontWeight: "700" }}
      >
        {label}
      </Text>
      <Text style={{ color: colors.primary, fontSize: 8, fontWeight: "700" }}>
        R$ {value.toFixed(2)}
      </Text>
    </View>
  );
        ...
        >
          ...
          {session.hasDivergence && (
            ...
            >
              ...
              >
                Δ {metrics.total - session.declaredCount > 0 ? "+" : ""}
...
function MetricItem({
  ...
  return (
    ...
    >
      ...
      <Text
        style={{ color: colors.textSubtle, fontSize: 9, fontWeight: "600" }}
      >
        {label}
      </Text>
      <Text
