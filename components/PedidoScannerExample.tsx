...
export const PedidoScannerExample: React.FC = () => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.subtitle}>Digite ou escaneie um código de pedido</Text>
          ...
          <View style={styles.pedidoInfo}>
            ...
            {pedido.entrega.transportadora && (
              <View style={styles.infoRow}>
                ...
                <Text style={styles.infoValue}>{pedido.entrega.transportadora}</Text>
              </View>
            )}
            ...
            {pedido.entrega.codigoRastreamento && (
              <View style={styles.infoRow}>
                ...
                <Text style={styles.infoValue}>{pedido.entrega.codigoRastreamento}</Text>
              </View>
            )}
          </View>
