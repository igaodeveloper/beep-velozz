...
import Animated, { FadeInDown, FadeOutDown, SlideInLeft, SlideOutRight } from 'react-native-reanimated';
      ...
      {loadingDrivers ? (
        ...
        <>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.75}
            style={{
              backgroundColor: selectedDriver ? colors.primary : colors.surface2,
              borderWidth: 1,
            ...
            <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', gap: 10 }}>
              <View
                style={{
                  ...
                  height: 40,
                  borderRadius: 10,
                  backgroundColor: selectedDriver ? colors.secondary : colors.surface,
                  alignItems: 'center',
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text
                  ...
                  numberOfLines={1}
                >
                  {selectedDriver ? selectedDriver.name : 'Selecione um motorista'}
                </Text>
              </View>
            </View>
            <MaterialIcons
                      ...
                      <Animated.View key={driver.id} entering={SlideInLeft.delay(index * 30)}>
                        <TouchableOpacity
                          ...
                          style={{
                            ...
                            borderBottomWidth: index < drivers.length - 1 ? 1 : 0,
                        ...
                        >
                          ...
                          <View
                            style={{
                              ...
                              borderRadius: 6,
                              borderWidth: 2,
                              borderColor: isSelected ? colors.secondary : colors.border2,
                              alignItems: 'center',
                              justifyContent: 'center',
                          ...
                          <TouchableOpacity
                            ...
                            style={{
                              padding: 6,
                              marginLeft: 8,
                              opacity: deletingDriverId === driver.id ? 0.5 : 1,
                            }}
                          >
