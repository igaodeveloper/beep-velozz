...
export class LocalizationService {
  ...
  private loadTranslations(): void {
    ...
    const ptBR: TranslationNamespace = {
      ...
      notifications: {
        ...
        session_summary:
          "Resumo da sessão: {scans} pacotes, {accuracy}% acurácia",
    ...
    const enUS: TranslationNamespace = {
      ...
      notifications: {
        ...
        session_summary:
          "Session summary: {scans} packages, {accuracy}% accuracy",
    ...
    const esES: TranslationNamespace = {
      ...
      achievements: {
        ...
        lightning_fast_desc:
          "Mantenga promedio de menos de 2 segundos por escaneo",
        accuracy_master_desc:
          "Mantenga 95% de precisión por 7 días consecutivos",
      ...
      notifications: {
        ...
        session_summary:
          "Resumen de sesión: {scans} paquetes, {accuracy}% precisión",
  ...
  private getTranslation(
    ...
    const namespaceTranslations =
      langTranslations[namespace as keyof TranslationNamespace];
